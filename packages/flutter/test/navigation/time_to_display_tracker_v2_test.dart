...
void main() {
  ...
  group(TimeToDisplayTrackerV2, () {
    ...
    group('when preparing app start', () {
      test('prepareInitialDisplay creates idle span at supplied start', () {
        final sut = fixture.getSut();
        ...
        final activeSpan = fixture.hub.getActiveSpan();
        expect(activeSpan, isA<RecordingSentrySpanV2>());
        expect(activeSpan!.name, 'root /');
        expect(activeSpan.startTimestamp, startTimestamp);
      });

      test('recordInitialDisplay ends TTID at supplied timestamp', () {
        final sut = fixture.getSut();
        final childSpans = fixture.captureChildSpans();
        final startTimestamp = DateTime.utc(2024, 1, 1, 12);
        ...
        sut.recordInitialDisplay(endTimestamp);
