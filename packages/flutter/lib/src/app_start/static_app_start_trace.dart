...
final class StaticAppStartTrace implements AppStartTrace {
  ...
  static StaticAppStartTrace? tryCreate({
    ...
    try {
      ...
      root = hub.startTransactionWithContext(
      ...
      if (!hub.tryScheduleFinalTimeout(
        root,
  ...
  void _createCompletedBreakdownSpans() {
    for (final phase in _data.nativePhaseIntervals) {
      _finishChild(
    ...
    _finishChild(
      ...
      startTimestamp: _data.processStartTimestamp,
      endTimestamp: _data.pluginRegistrationTimestamp,
    );
    _finishChild(
      operation: SentrySpanOperations.appStartSentrySetup,
      description: appStartSentrySetupDescription,
      startTimestamp: _data.pluginRegistrationTimestamp,
      endTimestamp: _data.sentrySetupTimestamp,
    );
  }
